...
namespace CamCook.Models
{
    ...
    public class Recipe
    {
        ...
        [FirestoreProperty("titulo")] public string Title { get; set; } = "";
        [FirestoreProperty("calorias")] public int Calories { get; set; }
        [FirestoreProperty("porciones")] public int Servings { get; set; }
        [FirestoreProperty("tiempoPrep")] public string PrepTimeText { get; set; } = "";
